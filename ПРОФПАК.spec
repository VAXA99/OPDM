...
datas = [('C:\\Users\\sched\\VsCodeProjects\\python\\OPDM\\app.py', '.')]
binaries = []
...
a = Analysis(
    ['C:\\Users\\sched\\AppData\\Local\\Temp\\tmpd98foyme.py'],
    pathex=['.'],
    binaries=binaries,
    datas=datas,
...
exe = EXE(
    ...
    icon=['C:\\Users\\sched\\VsCodeProjects\\python\\OPDM\\app_icon.ico'],
)
coll = COLLECT(
    exe,
    a.binaries,
